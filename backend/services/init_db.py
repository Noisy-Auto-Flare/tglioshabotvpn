...
async def init_screens(db: AsyncSession):
    ...
    default_screens = {
        "main_menu": {
            ...
            "image_url": "https://imgur.com/NlvaJ8Z"
        },
        "plans": {
            "text": "Выберите подходящий тарифный план:",
            "image_url": "https://imgur.com/nAq9ctR"
        },
        "connect_menu": {
        ...
        "payment": {
            ...
            "image_url": "https://imgur.com/Lsy2Oxm"
        },
        "profile": {
            "text": "👤 Профиль\n\n🆔 Ваш ID: <code>{telegram_id}</code>\n💰 Баланс: {balance}$\n📝 Статус: {status_text}\n{vpn_info}",
            "image_url": "https://imgur.com/0hUmM2h"
        },
        "info": {
            ...
            "image_url": "https://imgur.com/NjKKj8f"
        },
        "support": {
